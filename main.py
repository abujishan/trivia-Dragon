    ...
    async def showChecker(self):
        ...
        while not self.is_closed():
            ...
            if broadcast:
                ...
                channel = self.get_channel(config.581399322102672)
...
if __name__ == '__main__':
    client = MyClient()
    client.run(config.NTgwNjg1ODc0ODU0MTAxMDAy.XOetrw.dlHrh_Fe1HYCCcwooXhYeBa_goI)
